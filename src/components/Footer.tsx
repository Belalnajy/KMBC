          ...
          <div className="relative mt-16 sm:mt-20 mb-16 sm:mb-20 p-8 sm:p-12 md:p-16 rounded-md border border-border bg-card/40 backdrop-blur-sm text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-text-secondary text-sm sm:text-base max-w-lg mx-auto mb-8 leading-relaxed">
                Get in touch with our team for a free consultation and site assessment.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6">
            ...
            <ScrollReveal className="md:col-span-4" delay={0.1}>
              ...
              <div className="space-y-3.5">
                <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 group/link">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4 text-accent/50 group-hover/link:text-accent flex-shrink-0 mt-0.5 transition-colors">
                ...
                <a href="mailto:administration@kmbc-kw.com" className="flex items-center gap-3 group/link">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-4 h-4 text-accent/50 group-hover/link:text-accent flex-shrink-0 transition-colors">
            ...
            <ScrollReveal className="md:col-span-4" delay={0.2}>
              ...
              <div className="space-y-2.5 mb-8">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-foreground font-medium">08:00 — 16:00</span>
                </div>
                <div className="flex justify-between text-sm">
      ...
      <div className="border-t border-border/30">
        <div className="section-container py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-muted text-[11px] tracking-wider">
            &copy; {new Date().getFullYear()} Kuwait Modern Buildings Construction Co.
          </p>
          <p className="text-muted text-[11px] tracking-wider">
